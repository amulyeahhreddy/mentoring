...
for filepath in files_to_process:
    ...
    content = content.replace('bg-gray-900', 'bg-[#111118]')
    ...
    content = content.replace('bg-red-50', 'bg-[rgba(239,68,68,0.08)]')
    content = content.replace('bg-green-50/50', 'bg-[rgba(16,185,129,0.08)]')
    content = content.replace('bg-green-50', 'bg-[rgba(16,185,129,0.08)]')
    ...
    content = content.replace('border-gray-800', 'border-[rgba(255,255,255,0.06)]')
    ...
    content = content.replace('text-green-600', 'text-[#10b981]')
    ...
    content = content.replace('hover:bg-gray-800', 'hover:bg-[#16161f]')
